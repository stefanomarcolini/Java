...
public class FactoryInnerClasses {
	...
	public static FactoryInnerClasses create(String className, Object...params) throws UnsupportedOperationException {
		switch (className) {
			case "A":
				return new A();
			case "B":
	 ...
	 * */
	public static class A extends FactoryInnerClasses {
	 ...
	 * that can can be created by the Factory
	 * */
	public static class B extends FactoryInnerClasses {
	 ...
	 * that can can be created by the Factory
	 * */
	public static class C extends FactoryInnerClasses {
